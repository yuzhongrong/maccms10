...
<div id="member" class="fn-clear">
    <div id="left">
		...
		<ul>
			...
			<li class="hover"><a href="<?php echo url('user/plays'); ?>">播放记录</a></li>
    ...
    <div id="right">
		...
		<table width="770" border="0" cellspacing="1" cellpadding="0" class="table">
		  ...
		  <tr>
			...
			<td align="center" valign="middle" bgcolor="#FFFFFF"><a target="_blank" href="<?php echo $vo['data']['link']; ?>" class="fen">重新观看</a></td>
			<td align="center" valign="middle" bgcolor="#FFFFFF"><?php echo $vo['ulog_points']; ?></td>
			<td align="center" valign="middle" bgcolor="#FFFFFF"><a href="javascript:;" onclick="delData(<?php echo $vo['ulog_id']; ?>)" class="delete">删除</a></td>
		  </tr>
