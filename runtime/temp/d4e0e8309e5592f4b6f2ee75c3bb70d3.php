...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5dfd18504b271=explode(',',$maccms['search_hot']); if(is_array($_5dfd18504b271) || $_5dfd18504b271 instanceof \think\Collection || $_5dfd18504b271 instanceof \think\Paginator): if( count($_5dfd18504b271)==0 ) : echo "" ;else: foreach($_5dfd18504b271 as $key2=>$vo2): ?>
