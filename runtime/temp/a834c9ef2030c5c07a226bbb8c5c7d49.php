...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5dfd190e3f271=explode(',',$maccms['search_hot']); if(is_array($_5dfd190e3f271) || $_5dfd190e3f271 instanceof \think\Collection || $_5dfd190e3f271 instanceof \think\Paginator): if( count($_5dfd190e3f271)==0 ) : echo "" ;else: foreach($_5dfd190e3f271 as $key2=>$vo2): ?>
