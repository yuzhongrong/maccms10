<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"template/gay/html/user/login.html";i:1544283128;}*/ ?>
...
<html lang="zh-Hant">
 <head> 
  ...
  <meta property="og:url" content="//<?php echo $maccms['site_url']; ?>/index.php/user/login.html" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:title" content="登入 : <?php echo $maccms['site_name']; ?>" /> 
  <title>登入 : <?php echo $maccms['site_name']; ?></title> 
  <link rel="alternate" hreflang="x-default" href="//<?php echo $maccms['site_url']; ?>/index.php/user/login.html" /> 
  <link rel="alternate" hreflang="zh-Hans" href="//<?php echo $maccms['site_url']; ?>/index.php/user/login.html" /> 
  <link rel="canonical" href="//<?php echo $maccms['site_url']; ?>/index.php/user/login.html" /> 
   ...
   <div class="col-md-6 col-xs-12"> 
    <h4 style="margin-top:10px;margin-bottom:10px;"> 
     <ul class="nav nav-tabs" role="tablist"> 
	  <li role="presentation" class=""><a href="/index.php/user/reg.html">注册账号</a></li>
      <li role="presentation" class="active"><a href="/index.php/user/login.html">登入</a></li> 
     ...
     <div role="tabpanel" class="tab-pane active" id="login"> 
      <form method="post" id="fm" action=""> 
       <div class="form-group"> 
        <input class="input-lg form-control" id="user_name" name="user_name" placeholder="示例: ymyuanma" type="text" /> 
       </div> 
       <div class="form-group"> 
        <input class="form-control input-lg" id="user_pwd" placeholder="输入你的密码" name="user_pwd" type="password" /> 
       </div> 
	   <?php if($GLOBALS['config']['user']['login_verify'] == 1): ?>
	   <div class="form-group" style="overflow:hidden;">
		<input type="text" class="form-control input-lg" id="verify" name="verify" placeholder="请输入验证码" style="width:60%;float:left;margin-right:5%;">
	   ...
	   <?php endif; ?>
       <div class="form-group"> 
		<input type="button" id="btn_submit" class="btn btn-lg btn-primary btn-block btn-send" value="登入">
       </div> 
	...
	$(function(){
		...
		$('#btn_submit').click(function() {
			...
			$.ajax({
				...
				complete: function () {
					$("#btn_submit").css("background","#fa4646").val("登入");
				}
			});
