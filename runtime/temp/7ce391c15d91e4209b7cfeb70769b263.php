...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5dfd96eef2df2=explode(',',$maccms['search_hot']); if(is_array($_5dfd96eef2df2) || $_5dfd96eef2df2 instanceof \think\Collection || $_5dfd96eef2df2 instanceof \think\Paginator): if( count($_5dfd96eef2df2)==0 ) : echo "" ;else: foreach($_5dfd96eef2df2 as $key2=>$vo2): ?>
