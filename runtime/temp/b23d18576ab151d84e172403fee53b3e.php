...
<div id="member" class="fn-clear">
    <div id="left">
		...
		<ul>
			...
			<li class="hover"><a href="<?php echo url('user/favs'); ?>">我的收藏</a></li>
