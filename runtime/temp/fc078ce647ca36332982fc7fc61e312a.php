...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5dfd19049715a=explode(',',$maccms['search_hot']); if(is_array($_5dfd19049715a) || $_5dfd19049715a instanceof \think\Collection || $_5dfd19049715a instanceof \think\Paginator): if( count($_5dfd19049715a)==0 ) : echo "" ;else: foreach($_5dfd19049715a as $key2=>$vo2): ?>
    ...
    <ul class="directory-list">
        <li>
            <dl class="leixing">
                ...
                <?php if(empty($obj['type_extend']['class']) || (($obj['type_extend']['class'] instanceof \think\Collection || $obj['type_extend']['class'] instanceof \think\Paginator ) && $obj['type_extend']['class']->isEmpty())): $_5dfd1904970d4=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_5dfd1904970d4) || $_5dfd1904970d4 instanceof \think\Collection || $_5dfd1904970d4 instanceof \think\Paginator): if( count($_5dfd1904970d4)==0 ) : echo "" ;else: foreach($_5dfd1904970d4 as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5dfd190497090=explode(',',$obj['type_extend']['class']); if(is_array($_5dfd190497090) || $_5dfd190497090 instanceof \think\Collection || $_5dfd190497090 instanceof \think\Paginator): if( count($_5dfd190497090)==0 ) : echo "" ;else: foreach($_5dfd190497090 as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
        ...
        <li>
            <dl class="area">
                ...
                <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5dfd19049703d=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5dfd19049703d) || $_5dfd19049703d instanceof \think\Collection || $_5dfd19049703d instanceof \think\Paginator): if( count($_5dfd19049703d)==0 ) : echo "" ;else: foreach($_5dfd19049703d as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5dfd190496fec=explode(',',$obj['type_extend']['area']); if(is_array($_5dfd190496fec) || $_5dfd190496fec instanceof \think\Collection || $_5dfd190496fec instanceof \think\Paginator): if( count($_5dfd190496fec)==0 ) : echo "" ;else: foreach($_5dfd190496fec as $key=>$vo): ?>
        ...
        <li>
            <dl>
                ...
                <?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_5dfd190496f9a=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5dfd190496f9a) || $_5dfd190496f9a instanceof \think\Collection || $_5dfd190496f9a instanceof \think\Paginator): if( count($_5dfd190496f9a)==0 ) : echo "" ;else: foreach($_5dfd190496f9a as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5dfd190496f50=explode(',',$obj['type_extend']['year']); if(is_array($_5dfd190496f50) || $_5dfd190496f50 instanceof \think\Collection || $_5dfd190496f50 instanceof \think\Paginator): if( count($_5dfd190496f50)==0 ) : echo "" ;else: foreach($_5dfd190496f50 as $key=>$vo): ?>
